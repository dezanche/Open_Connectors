...
The connector boards comply with the *Physical Layer* of the [MRCODS Open Standard](https://github.com/umbertozanovello/OpenStandard-CoilID/tree/main) (MRI RF Coil Open Data Standard).

Approximate cost of all materials used for the prototype is $55 (USD).